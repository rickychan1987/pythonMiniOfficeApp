...
# --- CONFIGURATION ---
folder_path = r"D:\Administrator\Pictures\Camera Roll\spray"
csv_file = os.path.join(folder_path, "spray_list.csv")
excel_output = os.path.join(folder_path, "spray_photo_links.xlsx")
