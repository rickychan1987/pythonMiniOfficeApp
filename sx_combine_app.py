...
# --- CONFIGURATION ---
folder_path = r"D:\Administrator\Pictures\Camera Roll\SX"
csv_file = os.path.join(folder_path, "laser_han_dap_list.csv")
excel_output = os.path.join(folder_path, "sx_photo_links.xlsx")
